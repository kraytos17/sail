...
/// given version number, along with their last-modified timestamps.
...
pub fn is_stale_metadata_file(
    candidate_timestamp: chrono::DateTime<chrono::Utc>,
    current_metadata_timestamp: chrono::DateTime<chrono::Utc>,
) -> bool {
