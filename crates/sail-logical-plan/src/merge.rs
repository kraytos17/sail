...
use sail_common_datafusion::datasource::{OptionLayer, RowLevelOperationType, UpdateInfo};
...
impl RowLevelWriteNode {
    ...
    /// Create an UPDATE write node carrying the condition for the physical planner.
    pub fn new_update(
        raw_target: Arc<LogicalPlan>,
        raw_input_schema: DFSchemaRef,
        write_plan: Arc<LogicalPlan>,
