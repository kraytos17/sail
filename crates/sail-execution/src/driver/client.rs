...
use crate::driver::gen_::driver_service_client::DriverServiceClient;
use crate::driver::gen_::{
...
impl DriverClient {
    ...
    pub async fn report_worker_heartbeat(&self, worker_id: WorkerId) -> ExecutionResult<()> {
        let request = tonic::Request::new(gen_::ReportWorkerHeartbeatRequest {
            worker_id: worker_id.into(),
        });
        let response = self
            .inner
            ...
            .await?;
        let gen_::ReportWorkerHeartbeatResponse {} = response.into_inner();
        Ok(())
    }
    ...
    pub async fn report_worker_known_peers(
        ...
        let request = tonic::Request::new(gen_::ReportWorkerKnownPeersRequest {
            worker_id: worker_id.into(),
        ...
        let response = self
            ...
            .await?;
        let gen_::ReportWorkerKnownPeersResponse {} = response.into_inner();
        Ok(())
    }
    ...
    pub async fn report_task_status(
        ...
        let request = tonic::Request::new(ReportTaskStatusRequest {
            ...
            status: gen_::TaskStatus::from(status) as i32,
            message,
            cause,
            sequence,
        });
