...
impl From<WorkerLocation> for gen_::WorkerLocation {
...
impl TryFrom<gen_::WorkerLocation> for WorkerLocation {
    type Error = ExecutionError;

    fn try_from(value: gen_::WorkerLocation) -> Result<Self, Self::Error> {
